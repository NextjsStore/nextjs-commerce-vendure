 ...
 * @returns
 */
export const updateCart2 = (
  existingCart,
  products,
  qtyToBeAdded,
  newQty = false
) => {
  const updatedProducts = getUpdatedProducts2(
    existingCart.products,
    products,
    qtyToBeAdded,
    newQty
 ...
 * @returns
 */
export const getUpdatedProducts2 = (
  ...
  const productExitsIndex = isProductInCart2(
    existingProductsInCart,
    parseInt(products.productId)
  )
  ...
  if (-1 < productExitsIndex) {
    ...
    updatedProduct.qty = newQty
      ? parseInt(newQty)
      : parseInt(parseInt(updatedProduct.qty) + qtyToBeAdded)
