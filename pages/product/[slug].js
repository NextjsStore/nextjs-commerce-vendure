...
export default function Product(props) {
    ...
    const { product,productrelate } = props;
                            ...
                            <Grid container direction="row" lg={12}>
                                <Grid item xs={12} sm={12} md={6} lg={6}>
                                    <div className={classes.imgagesDetail}>
                                        <img src={product?.assets[0].source} alt="" />
                                        <div className={classes.galleryImages}>
                                            {!isEmpty(product?.assets) ? (
                                                <GalleryCarousel gallery={product?.assets} />
                                            ) : !isEmpty(product?.assets) ? (
                                                <img
                                                    src={product?.assets?.source}
                                                    alt="Product Image"
                                                    height="auto"
                                                    srcSet={product?.assets?.source}
                                                />
                                            ) : null}
                                        </div>
                                    </div>
                                ...
                                <Grid item xs={12} sm={12} md={6} lg={6} >
                                    <div className='descDetail'>
                                        ...
                                        <h3 className={classes.priceproduct}>${product.variants[0].price}</h3>
                                        <div
                                        ...
                                        <div className={classes.product_meta}>
                                            ...
                                            {!isEmpty(product?.collections) ? (
                                                ...
                                                <div className={classes.sku_name}> {product.collections.name}</div>
                                            ) : null}
                                        </div>
                                    </div>
                                </Grid>
                                                ...
                                                <div className={classes.box_product}>
                                                    ...
                                                    <div className={classes.cardBody}>
                                                        ...
                                                        <h4 className={classes.cardPrice}>
                                                            <span className={classes.price_sales}>${item.variants[0].price}</span>
                                                        </h4>
                                                    </div>
                                                </div>
                                            </div>
